...
var pipes1, pipes2, fb, fb2, bg, ground, coin, star;
var coinsGroup;
var pipe1Img, pipe2Img, fbImg, fb2Img, bgImg, groundImg, coinImg,restartImg, starImg;
var score = 0;
...
function spawnStars(){
  if(frameCount % 400 === 0){
    star = createSprite(795,10,50,50);
    star.y = Math.round(random(230,370));
    star.velocityX = -13;
